...
import com.sumin.shoppinglist.presentation.ShopItemViewHolder
...
//            false
    ...
    override fun onBindViewHolder(viewHolder: ShopItemViewHolder, position: Int) {
        ...
        // Мы бы обращались к элементам так: binding.tvName.text = shopItem.name
